...
local Window  = Library.CreateLib("Script Made By Legend", "BloodTheme")
...
local Section = Tab:NewSection("Made By Legend")
local Section = Tab:NewSection("DISCORD https://discord.gg/6VPsntDRWP")
